    ...
    <section id="home" className="relative min-h-screen bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute left-1/2 top-[6%] w-60 -translate-x-1/2 opacity-90 mix-blend-screen md:w-80"
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute left-1/2 top-[34%] w-72 -translate-x-1/2 opacity-90 mix-blend-screen md:w-96"
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute right-[2%] top-[4%] w-52 opacity-90 mix-blend-screen md:right-[6%] md:w-72"
